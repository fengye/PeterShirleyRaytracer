...
void write_color(std::ostream& out, const color& pixel_color, int samples_per_pixel)
{
	...
	debug_printf("%d %d %d\n", 
		(int)(255.999 * clamp(r, 0.0f, 0.999f)),
		(int)(255.999 * clamp(g, 0.0f, 0.999f)),
		(int)(255.999 * clamp(b, 0.0f, 0.999f)));
}
...
void write_color_bitmap(Bitmap* bitmap, int x, int y, const color& pixel_color, int samples_per_pixel)
{
	...
	bitmapUpdateRGBA(bitmap, (u32)x, (u32)y, 
		(u8)(255.999 * clamp(r, 0.0f, 0.999f)),
		(u8)(255.999 * clamp(g, 0.0f, 0.999f)),
		(u8)(255.999 * clamp(b, 0.0f, 0.999f)), 0xff);
}
